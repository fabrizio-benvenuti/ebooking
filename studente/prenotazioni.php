        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td >
                            <form action="sessioni.php" method="post" class="header-search">

                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Cerca Tutor o Email (AAAA-MM-GG)" list="tutors" >&nbsp;&nbsp;
                        ...
                        <tbody>
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    $sqlmain= "select * from schedule inner join tutor on schedule.docid=tutor.docid where schedule.scheduleid=? order by schedule.scheduledate desc";
                                    $stmt = $database->prepare($sqlmain);
                                    ...
                                    $sql2="select * from appuntamento where scheduleid=$id";
                                    //echo $sql2;
                                     $result12= $database->query($sql2);
                                     $apponum=($result12->num_rows)+1;
                                    
                                    echo '
                                        <form action="prenotazioni-completate.php" method="post">
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            Nome Tutor:  &nbsp;&nbsp;<b>'.$docname.'</b><br>
                                                            Email Tutor:  &nbsp;&nbsp;<b>'.$docemail.'</b> 
                                                        </div>
                                                        <div class="h3-search" style="font-size:18px;">
                                                          
                                                        </div><br>
                                                        <div class="h3-search" style="font-size:18px;">
                                                            Titolo Sessione: '.$title.'<br>
                                                            Data Sessione: '.$scheduledate.'<br>
                                                            Inizio Sessione : '.$scheduletime.'<br>
                                                            Penale Cancellazione : <b>EUR 30</b>
                                                        </div>
                                                        <br>    
                                                </div>         
                                            </div>
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%;padding-top: 15px;padding-bottom: 15px;">
                                                        <div class="h1-search" style="font-size:20px;line-height: 35px;margin-left:8px;text-align:center;">
                                                            Il numero del tuo appuntamento
                                                        </div>
                                                        <center>
                                        ...
                                        <tr>
                                            <td>
                                                <input type="Submit" class="login-btn btn-primary btn btn-appuntamento" style="margin-left:10px;padding-left: 25px;padding-right: 45px;padding-top: 10px;padding-bottom: 10px;width:95%;text-align: center;" value="Prenota Adesso" name="appuntamentonow"></button>
                                            </form>
                                            </td>
                                        </tr>
                                        '; 
